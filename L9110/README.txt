Librería para usar el driver de motores L9110 con 4 pines de control

Los archivos de librería L9110.h y L9110.cpp deben estar en la carpeta de librerías personales de Arduino

Las funciones de esa librería son

L298N nombredelobjeto(AIA, AIB, BIA, BIB); // para crear el objeto que se usará luego declarando los pines de Arduino
